...
public class MyContentProvider extends ContentProvider {
    ...
    private static HashMap<String, String> BOOKS_PRỌECTION_MAP;
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriMatcher.match(uri)){
            case ALLITEMS:count=db.delete(TABLE_NAME,selection,selectionArgs);break;
            case ONEITEM:String id=uri.getPathSegments().get(1);
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        throw new SQLException("Faile to connect dtb"+uri);
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (uriMatcher.match(uri)){
            case ALLITEMS:
                sqlite_builder.setProjectionMap(BOOKS_PRỌECTION_MAP);
                break;
            case ONEITEM:
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        int count=0;
        switch (uriMatcher.match(uri)){
            case ALLITEMS:count=db.update(TABLE_NAME,values,selection,selectionArgs);break;
            case ONEITEM:count=db.update(TABLE_NAME,values,"id_book"+"="+uri.getPathSegments().get(1)+(!TextUtils.isEmpty(selection)?"AMD("+selection+')':""),selectionArgs);
        }
